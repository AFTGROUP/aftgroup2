...
<div id="whyyy">
  <section class="container py-5 my-2 my-md-4 my-lg-5 " id="why">
    <div class="" style="position: relative; margin-left:-190px;">
      <img src="{{asset('assets/img/Polygon 2.png')}}" class="pihande" alt="pyramide">
      <img src="{{asset('assets/img/Polygon 3.png')}}" class="pih mt-3" style="margin-left: 3px;" alt="pyramide">
    </div>
    <div class="row">
      <div class="col-md-6">
        <div class="attendant">
      ...
      <div class="col-md-6">
        ...
        <p class="tester" style="text-align: justify;">Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide thEnver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services.e best service for those of you who use our services.</p>
      </div>
    </div>
  </section>
</div>
<!-- ========== End strategie maketing ========== -->
<!-- ========== Start sites bureautique ========== -->
<section class="container py-5 my-2 my-md-4 my-lg-5 m" id="why">
  <div class="row">
    <div class="col-md-6">
...
<div id="whyyy">
  <section class="container py-5 my-2 my-md-4 my-lg-5 " id="why">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <h1 class="text-light">Solutions technologiques <br>et outils TIC</h1>
        <p class="tester" style="text-align: justify;">Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide thEnver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services Enver studio is a digital studio that offers several services such as UI/UX Design to developers, we will provide the best service for those of you who use our services.e best service for those of you who use our services.</p>
      </div>
    </div>
  </section>
