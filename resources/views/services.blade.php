...
<div class="row py-4">
  <div class="col-md-6">
      <div style="position: relative;">
          ...
          <div class="fas fa-icone-1" style="position: absolute; top: 30%; left: 12%; font-size: 16px; color: white;">
            <a style="text-decoration:none" href="#" data-toggle="tooltip" title="">111
            <span style="font-size: 15px; color: white; margin-left: 3px;">Site e-commerce </span>
            </a>
        </div>
        <div class="fas fa-icone-1" style="position: absolute; top: 40%; left: 12%; font-size: 16px; color: white;">
          <a style="text-decoration:none" href="#" data-toggle="tooltip" title="">111
